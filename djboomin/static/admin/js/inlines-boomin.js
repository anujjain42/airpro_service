...
*/
(function($) {
    jQuery.fn.formset = function(opts) {
        var options = jQuery.extend({}, $.fn.formset.defaults, opts);
        var $this = $(this);
    ...
    // Tabular inlines ---------------------------------------------------------
    jQuery.fn.tabularFormset = function(options) {
        var $rows = $(this);
    ...
    // Stacked inlines ---------------------------------------------------------
    jQuery.fn.stackedFormset = function(options) {
        var $rows = $(this);
